...
function Login() {
 ...
 if (view === 'login') {
  return (
    <div className="login bg-gray-100 min-h-screen bg-cover bg-center flex items" style={{ backgroundImage: `url(${Banner})`, backgroundSize: 'cover' }}>
      <div className="container max-w-lg mx-auto px-6 mr-5 mt-48">
